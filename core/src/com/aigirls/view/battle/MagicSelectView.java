...
public class MagicSelectView extends SelectView {
    private static int START_X = (int) Math.round(0.15 * GameConfig.GAME_WIDTH);
    ...
    private static int VERTICAL_INTERVAL = (int) Math.round(0.1 * GameConfig.GAME_HEIGHT);
    ...
    private static int CARD_WIDTH =
            GameConfig.GAME_WIDTH - (2*START_X+CARD_HALF_NUMS*HORAIZONTAL_INTERVAL);
    private MagicCardView[] cards;

    public MagicSelectView(ActiveMagicModel[] magics)
    {
